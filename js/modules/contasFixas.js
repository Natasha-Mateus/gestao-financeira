...
export function renderContasFixas(container) {
  ...
  container.innerHTML = `
    ...
    <div class="card" style="margin-bottom:24px">
      ...
      <div id="form-cf-body" class="collapsible-body">
  ...
  function resetForm() {
    ...
    document.getElementById('cf-responsavel').value = 'Natasha';
  ...
  async function carregarLista() {
    ...
    function render() {
      ...
      listaEl.innerHTML = `
          <table>
            <thead><tr><th>Nome</th><th>Valor</th><th>Vencimento</th><th>Responsável</th><th>Status (${mes})</th><th>Pago com</th><th></th></tr></thead>
            <tbody>
              ${templates.map(t => {
      ...
      listaEl.querySelectorAll('[data-editar]').forEach(btn => {
        btn.addEventListener('click', () => {
          ...
          document.getElementById('cf-responsavel').value = t.responsavel;
