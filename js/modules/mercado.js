...
export async function renderMercadoCompra(container) {
    ...
    <div class="card" style="margin-bottom:24px">
      ...
      <div id="form-compra-body" class="collapsible-body collapsed">
        ...
        <div class="grid grid-4" style="margin-top:12px">
          ...
          <div id="m-vale-tipo-wrap" class="conditional">
            <label>Tipo de saldo</label>
            <select id="m-vale-tipo"><option value="livre">Livre</option><option value="voucher">Voucher</option></select>
          </div>
  ...
  document.getElementById('m-forma-pagamento').addEventListener('change', (e) => {
    ...
    document.getElementById('m-vale-tipo-wrap').classList.toggle('show', isVale);
  ...
  async function carregarParaEdicao(compra) {
    ...
    document.getElementById('m-vale-tipo-wrap').classList.toggle('show', compra.formaPagamento === 'vale');
    ...
    if (compra.valeTipo) document.getElementById('m-vale-tipo').value = compra.valeTipo;
  ...
  async function salvarCompra() {
    ...
    const valeTipo = formaPagamento === 'vale' ? document.getElementById('m-vale-tipo').value : null;
    ...
    const payload = { data, mercado, modalidade, taxaEntrega, desconto, formaPagamento, cartaoId, parcelado, numParcelas, valeTitular, valeTipo, contaSaidaId, valorTotal, itens };
