...
- − Variáveis já registradas com data naquele mês
- − Mercado já registrado com data naquele mês (exceto vale)
- − Cartão: parcelas já lançadas + recorrências (assinaturas), pela competência de vencimento

Tudo somado ao saldo atual em conta. Só entra o que já foi cadastrado — nada é estimado do nada.
